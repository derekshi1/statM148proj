...
Come up with the training data set we have and train Random forest, make predictions then use CP profiles: focus on cp profiles for categorical and numerical predictors

also fit a logistic regression and have the cp model for that
